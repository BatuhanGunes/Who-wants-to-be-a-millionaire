...
public class Main {
	...
	public static void main(String[] args) {
		...
		String Joker[]={"Seyirciye Sorma","0","Arama","0","Yari Yariya","0","Çift Cevap","0"};
		String Soru[][]=Sorular.Soru();
			...
			System.out.println("Lütfen Cevaplari büyük harfle yaziniz.");
			...
			while(durum){
				...
				ParaYazdir.KazanılanParaYazdir(Para, durum, dongu);		
	}
			System.out.println("kazandiginiz para ödülü: "+Para[dongu]);
